...
#define TIMER_THREAD_LIST_TIMEOUT_MS		300 // Milliseconds 
...
typedef struct _FLDRIVERDATA
{
	...
	PKEVENT				TimerThreadSleepWakeup; // wakeup event
	PKTIMER				Timer; // timer object
	LARGE_INTEGER		TimerDueTime; // timer timeout
