...
/**
 * Implements a horizontal page adapter Based on Jake Wharton sample
 * 
 */
public class TabPageIndicator extends View implements
	...
	public TabPageIndicator(Context context, AttributeSet attrs, int defStyle) {
		...
		m_footer_line_height = res
				.getDimension(R.dimen.default_footer_line_height);
		m_footer_padding = res.getDimension(R.dimen.default_footer_padding);
		m_footer_triangle_color = res
				.getColor(R.color.default_footer_triangle_color);
		m_footer_triangle_height = res
				.getDimension(R.dimen.default_footer_triangle_height);
	...
	protected void paintText(Canvas canvas) {
		...
		// Logger.e("Count: " + m_view_pager.getAdapter().getCount() +
	...
	protected void onDraw(Canvas canvas) {
		...
		m_path_footer_triangle.moveTo(width / 2, height - m_footer_line_height
				- m_footer_triangle_height);
		m_path_footer_triangle.lineTo(width / 2 + m_footer_triangle_height,
				height - m_footer_line_height);
		m_path_footer_triangle.lineTo(width / 2 - m_footer_triangle_height,
				height - m_footer_line_height);
	...
	public boolean setViewPager(ViewPager view_pager) {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (height_mode != MeasureSpec.EXACTLY) {
			...
			text_height += m_footer_line_height + m_footer_padding
					+ m_footer_triangle_height;
	...
	public void onPageScrolled(int position, float positionOffset,
		...
		if (m_listener != null) {
			...
			// notify listener
			//
			m_listener.onPageScrolled(position, positionOffset,
