...
public class CloudViewScreenBoxManager
{
	 ...
	 */
	public CloudViewScreenBoxManager(int width, int max_font_size)
	{
		m_width = width;
	 ...
	 * @param offset height offset to start from
	 * @param height increment offset
	 * @param box_size determines the box size in which the new space is split into
	 */
