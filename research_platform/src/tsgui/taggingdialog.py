...
class TaggingDialog(QtGui.QWidget):  
    ...
    def __init__(self, parent=None):
        ...
        self.__close_button = QtGui.QPushButton(self.__horizontal_layout_widget)
        self.__close_button.connect(self.__close_button, QtCore.SIGNAL("clicked()"), self, QtCore.SIGNAL("cancel_button_pressed()"))
        self.__horizontal_layout.addWidget(self.__close_button)
    ...
    def retranslate_user_interface(self):
        ...
        self.__close_button.setToolTip(QtGui.QApplication.translate("tagWidget", "cancel current operation", None, QtGui.QApplication.UnicodeUTF8))
        self.__close_button.setText(QtGui.QApplication.translate("tagWidget", "Cancel", None, QtGui.QApplication.UnicodeUTF8))
